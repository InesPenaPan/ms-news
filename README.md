...
```
Una vez levantado el contenedor, la API estará disponible en el puerto `8082`. Puedes verificar el funcionamiento realizando peticiones a través de tu navegador, cURL o Postman:
